...
public class FilmServiceImpl implements FilmService {
    ...
    public FilmServiceImpl(FilmDao filmDao, GenreDao genreDao, TicketDao ticketDao, FilmSessionDao filmSessionDao, SeatDao seatDao) {
    ...
    @Override
    public List<CompositeFilm> getFilmsWithTheirGenres(int start, int step, String sortBy) {
